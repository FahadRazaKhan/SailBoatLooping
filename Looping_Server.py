...
def looping():
    ...
    while True:
        ...
        if ReceivedData.upper() == "C": # if User sends 'C' cancel the looping
            ...
            PWM1 = 1100
            PWM2 = 1100
            pi.set_servo_pulsewidth(ESC1, PWM1)
            pi.set_servo_pulsewidth(ESC2, PWM2)
            time.sleep(4)
    ...
    try:
        ...
        while True:
            ...
            try:
                ...
                DataPoints.append([timevalue, currentvalue, voltagevalue, powervalue, PWM1, PWM2]) # Updating DataPoints Array

            except DeviceRangeError:
                print('Device Range Error')

            time.sleep(0.25) # Reading value after 1/4th second
        ...
        for Time, value1, value2, value3, value4, value5 in (DataPoints): # Writing Data in XLSX file
...
def ESC_Calibration():
    ...
    PWM1 = 1000
    PWM2 = 1000
    pi.set_servo_pulsewidth(ESC1, PWM1) # Min. Throttle
    pi.set_servo_pulsewidth(ESC2, PWM2) # Min. Throttle
    time.sleep(2)

    PWM1 = 2000
    PWM2 = 2000
    pi.set_servo_pulsewidth(ESC1, PWM1) # Max. Throttle
    pi.set_servo_pulsewidth(ESC2, PWM2) # Max. Throttle
    time.sleep(2)

    PWM1 = 1100
    PWM2 = 1100
    pi.set_servo_pulsewidth(ESC1, PWM1) # Slightly open throttle
    pi.set_servo_pulsewidth(ESC2, PWM2) # Slightly open throttle
    time.sleep(1)
